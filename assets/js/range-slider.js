(function ($) {
  ...
  $(document).ready(function () {
    ...
    noUiSlider.create(altezzaSlider, {
      start: [$final_pass_min, $final_pass_max],
      step: 1,
      range: {
        min: [$final_pass_min],
        max: [$final_pass_max],
    ...
    noUiSlider.create(larghezzaSlider, {
      start: [$final_largh_min, $final_largh_max],
      step: 1,
      range: {
        min: [$final_largh_min],
        max: [$final_largh_max],
    ...
    noUiSlider.create(ingaltezzaSlider, {
      start: [$final_ing_alt_min, $final_ing_alt_max],
      step: 1,
      range: {
    ...
    noUiSlider.create(inglarghezzaSlider, {
      start: [$final_ing_larg_min, $final_ing_larg_max],
      step: 1,
      range: {
